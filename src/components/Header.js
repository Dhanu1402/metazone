function Header() {
  return (
    <div className="flex justify-between items-center mb-4">
      <div>
        <h1 className="text-xl font-semibold">List of all Director profiles</h1>
      ...
      <div className="flex space-x-6">
        <div className="flex">
          <button className="btn rounded-l-md flex gap-2">
            <svg
          ...
          <button className="btn rounded-r-md flex gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <button className="flex border border-black rounded-md items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
